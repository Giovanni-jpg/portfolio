...
const Portfolio = () => {
  const portfolios = [
    ...
    },
    {
      ...
      description:
        'Dynamic frontend for AI-powered logistic software (6 months internship)',
      techStack: [
    ...
    },
    {
      ...
      title: 'Cocktail',
      description:
        'A Web App to manage enrollments courses for IMT Mines Albi teachers',
      techStack: [
  ...
  return (
    <div
      name='portfolio'
      className='bg-gradient-to-b from-black to-gray-800 w-full text-white pt-20 pb-10'
    >
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0'>
          {portfolios.map(
            ({ id, src, title, description, techStack, link, portfolio }) => (
                ...
                <div className='flex justify-around items-center'>
                  ...
                  {link && (
                    <a
                      ...
                      target='_blank'
                      rel='noreferrer'
                      className='text-gray-500 underline hover:text-white duration-150'
                    >
