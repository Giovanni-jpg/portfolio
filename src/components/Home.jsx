    ...
    >
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full'>
          <h2 className='text-4xl sm:text-7xl font-bold text-white'>Hi there, my name is Giovanni Massiot</h2>
          <p className='text-gray-500 py-4 max-w-md'>
          I'm a Software Engineer, graduated from IMT Mines Albi in France. I am currently seeking for a Full Stack Engineering position in Barcelona or remote.
          </p>
          <div>
